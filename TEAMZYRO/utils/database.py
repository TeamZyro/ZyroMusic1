...
from pymongo.errors import ConnectionFailure  # Use ConnectionFailure instead
import asyncio
...
async def get_catbox_url(video_id: str):
    try:
        ...
        return await get_catbox_url(video_id)
...
async def save_catbox_url(video_id: str, catbox_url: str):
    try:
        ...
        print(f"MongoDB connection error: {e}")
        await asyncio.sleep(1)
        return await save_catbox_url(video_id, catbox_url)
